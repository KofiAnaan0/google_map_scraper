        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            for listing in listings:
                try:
                    ...
                    website_xpath = '//a[@class="CsEnBe" and @data-item-id="authority"]'
                    phone_number_xpath = '//button[contains(@data-item-id, "phone:tel:")]//div[contains(@class, "fontBodyMedium")]'
                    review_count_xpath = '//button[contains(@class, "HHrUdb fontTitleSmall rqjGif")]//span'
                    reviews_average_xpath = '//div[contains(@class, "fontDisplayLarge")]'
                    ...
                    if page.locator(website_xpath).count() > 0:
                        business.website = page.locator(website_xpath).all()[0].get_attribute('href')
                    else:
                    ...
                    if page.locator(review_count_xpath).count() > 0:
                        business.reviews_count = page.locator(review_count_xpath).all()[0].inner_text()
                    else:
                        business.reviews_count = "N/A"
                    if page.locator(reviews_average_xpath).count() > 0:
                        business.reviews_average = page.locator(reviews_average_xpath).all()[0].inner_text()
                    else:
                        business.reviews_average = "N/A"
                    # if page.locator(review_count_xpath).count() > 0:
